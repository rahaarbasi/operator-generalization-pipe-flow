...
def main() -> None:
    ...
    per_sample_path = Path(
        f"results/leave_one_geometry_out_{safe_geometry}_{args.sampling}_per_sample.csv"
    )
    summary_path = Path(
        f"results/leave_one_geometry_out_{safe_geometry}_{args.sampling}_summary.csv"
    )
